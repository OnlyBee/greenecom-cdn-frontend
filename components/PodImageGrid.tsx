  ...
  return (
    <div className="mt-12">
          ...
          <div key={index} className="group relative rounded-lg overflow-hidden shadow-lg bg-gray-800 aspect-square border border-gray-700">
            ...
            <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-60 transition-all duration-300 flex items-center justify-center gap-4">
              ...
              <a
                ...
                download={image.name}
                title="Download"
                className="opacity-0 group-hover:opacity-100 transform group-hover:scale-100 scale-90 transition-all duration-300 bg-purple-600 text-white p-3 rounded-full shadow-lg hover:bg-purple-700"
              >
                <DownloadIcon />
              </a>
            </div>
      ...
      {previewImage && (
          ...
          >
              <button 
                className="absolute top-4 right-4 text-white hover:text-purple-400 transition-colors z-50 bg-black/50 rounded-full p-1"
                onClick={(e) => {
                    e.stopPropagation();
                    setPreviewImage(null);
                }}
