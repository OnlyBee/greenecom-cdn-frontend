...
export const PodImageUploader: React.FC<ImageUploaderProps> = ({ onFileSelect, previewUrl }) => {
  ...
  const uploaderContent = previewUrl ? (
    ...
    <div className="flex flex-col items-center justify-center text-center px-4">
        <UploadIcon />
        <p className="mt-2 text-lg font-semibold text-gray-300">Drag & drop or paste image here</p>
        <p className="text-sm text-gray-500">or <span className="font-semibold text-purple-400">click to browse</span></p>
    </div>
  );
