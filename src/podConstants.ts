...
export const VARIATION_COLORS: Color[] = [
  ...
  { name: "Sand", value: "SAND", hex: "#d8c6b1" },
  ...
  { name: "Ash Grey", value: "ASH GREY", hex: "#B2BEB5" },
  { name: "Light Blue", value: "LIGHT BLUE", hex: "#ADD8E6" },
  { name: "Charcoal", value: "CHARCOAL", hex: "#36454F" },
  { name: "Dark Heather", value: "DARK HEATHER", hex: "#555555" },
  { name: "Purple", value: "PURPLE", hex: "#800080" },
  { name: "Orange", value: "ORANGE", hex: "#FFA500" },
];

export const MOCKUP_PROPS = [
    "a ceramic coffee mug",
    "a plaid scarf",
    "a plain soft scarf",
    "a small succulent pot",
    "a vintage book",
    "a pen and notebook",
    "white sneakers",
    "a bluetooth speaker",
